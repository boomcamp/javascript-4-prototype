...
//Now create and push into your users array 3 separate instances of User using the data from above in that exact order
  ...
  users0 = new User('Aodhan' , 'aodhan@boom.camp' , 'iLoveJS');
  users1 = new User('Greg' , 'greg@boom.camp' , 'iLovePython');
  users2 = new User('Oscar' , 'oscar@boom.camp' , 'iLoveSoccer');

  users.push(users0, users1, users2);
...
users3 = new User('Bryan' , 'bryan.alfuente@boom.camp' , 'iLoveBooty');
