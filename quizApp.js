...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
  var User1 = new QuizUser('Daniel', 'daniel.nebreja@boom.camp', '1234', '100');
  quizUsers.push(User1);

  var User2 = new QuizUser('Edward', 'edward.nayve@boom.camp', '1234', '100');
  quizUsers.push(User2);

  var User3 = new QuizUser('Kobe', 'kobe.bryant@boom.camp', '1234', '100');
