...
//code here
quizUsers[0] = new QuizUser("Aodhan", "aodhan@boom.camp", "iLoveJS", "100");
quizUsers[1] = new QuizUser("Greg", "greg@boom.camp", "iLovePython", "98");
quizUsers[2] = new QuizUser("Oscar", "oscar@boom.camp", "iLoveSoccer", "99");
...
//code here
for (i in quizUsers) {
  console.log(quizUsers[i].name, quizUsers[i].email, quizUsers[i].password);
}
for (i in questions) {
  console.log(
    questions[i].title,
    questions[i].answersArray,
