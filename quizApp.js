...
//Let's say three people signed up for our service, create 3 instances of User and add each to the users Array
  ...
  //code here
  var user1 = new QuizUser('Hazel Remorosa', 'hazel.remorosa@boom.camp', 'iLoveYou', 90);
  quizUsers.push(user1);

  var user2 = new QuizUser('Diana Geromo', 'diane.geromo@boom.camp', 'iLoveNoteBooks', 89);
  quizUsers.push(user2);
  
  var user3 = new QuizUser('Seatiel Austria', 'seatiel.austria@boom.camp', 'iLoveMovies', 93);
